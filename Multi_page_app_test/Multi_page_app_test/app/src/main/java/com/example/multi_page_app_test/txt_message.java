package com.example.multi_page_app_test;
...
import com.example.multi_page_app_test.R;
...
public class txt_message extends AppCompatActivity {
    ...
    public void send(View view){
        String phoneNumber = ((EditText) findViewById(R.id.Message_txt)).getText().toString();
